...
var BracketsMissmatchException = /** @class */ (function (_super) {
    __extends(BracketsMissmatchException, _super);
    function BracketsMissmatchException(message) {
        return _super.call(this, message) || this;
    }
    return BracketsMissmatchException;
