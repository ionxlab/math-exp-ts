...
var UndefinedExpressionStringException = /** @class */ (function (_super) {
    __extends(UndefinedExpressionStringException, _super);
    function UndefinedExpressionStringException(message) {
        return _super.call(this, message) || this;
    }
    return UndefinedExpressionStringException;
