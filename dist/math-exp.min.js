...
/*!*******************************************!*\
  ...
  \*******************************************/(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Expression=void 0;const s=r(/*! ../abstract/OperatorAbstract */"./src/expression/abstract/OperatorAbstract.ts"),o=r(/*! ../abstract/OperandAbstract */"./src/expression/abstract/OperandAbstract.ts"),n=r(/*! ../abstract/TermAbstract */"./src/expression/abstract/TermAbstract.ts"),a=r(/*! ../abstract/OperatorLeftRightAbstract */"./src/expression/abstract/OperatorLeftRightAbstract.ts"),i=r(/*! ../abstract/OperatorFunctionAbstract */"./src/expression/abstract/OperatorFunctionAbstract.ts"),c=r(/*! ../operands */"./src/expression/operands/index.ts"),p=r(/*! ../../exceptions/MissingTermException */"./src/exceptions/MissingTermException.ts"),u=r(/*! ../../exceptions/MissingOperandException */"./src/exceptions/MissingOperandException.ts"),l=r(/*! ../../exceptions/EmptyExpressionException */"./src/exceptions/EmptyExpressionException.ts");class d extends n.TermAbstract{constructor(...e){super(),this.precedence=19,this._brackets=!0,this._terms=new Array,void 0!==e&&(this._terms=this._terms.concat(e))}get terms(){return this._terms}set terms(e){this._terms=e}get brackets(){return this._brackets}set brackets(e){this._brackets=e}evaluate(){if(0==this._terms.length)throw new l.EmptyExpressionException;d.Log("Evaluating:",this.toString());let e=this.clone();for(;e._terms.length>1||!(e._terms[0]instanceof c.Constant);){let t=-1,r=-1;e._terms.forEach(((e,s)=>{e.precedence>t&&(t=e.precedence,r=s)})),d.evaluateTerm(e,r),d.Log("Temporary expression:",e.toString())}return e._terms[0].evaluate()}static evaluateTerm(e,t){const r=e._terms[t];d.Log("Evaluating Term:",r.toString());let n=0;if(!r)throw new p.MissingTermException("Term at '"+t+"' is missing.");if(r instanceof d)d.Log("Term is an 'Expression'"),n=r.evaluate(),e._terms[t]=new c.Constant(n,!0);else if(r instanceof o.OperandAbstract)r instanceof c.Constant&&d.Log("Term is a 'Constant'"),r instanceof c.Variable&&d.Log("Term is a 'Variable'"),n=r.evaluate(),e._terms[t]=new c.Constant(n,r.brackets);else if(r instanceof s.OperatorAbstract)if(r instanceof a.OperatorLeftRightAbstract){d.Log("Term is an 'OperatorLeftRight'");const s=e._terms[t-1],o=e._terms[t+1];if(!(s instanceof c.Constant))throw new u.MissingOperandException("Operator '"+r.toString()+"' left argument '"+s.toString()+"' is invalid.");if(!(o instanceof c.Constant))throw new u.MissingOperandException("Operator '"+r.toString()+"' right argument '"+o.toString()+"' is invalid.");n=r.evaluate(s,o),d.Log("Evaluated Value: ",n),e._terms[t]=new c.Constant(n),e._terms.splice(t+1,1),e._terms.splice(t-1,1)}else if(r instanceof i.OperatorFunctionAbstract){d.Log("Term is an 'OperatorFunction'");const s=e._terms[t+1];if(!(s instanceof c.Constant))throw new u.MissingOperandException("Operator '"+r.toString()+"' argument '"+s.toString()+"' is invalid.");n=r.evaluate(s),e._terms[t]=new c.Constant(n),e._terms.splice(t+1,1)}else d.Log("Unknown operator term ?");else d.Log("Unknown term ?");return e}static Log(...e){d.debug&&console.log.apply(console,e)}clone(){let e=new d;return e.brackets=this.brackets,e._terms=e._terms.concat(this._terms),e}toString(){let e="";return this._terms.forEach(((t,r)=>{e+=t.toString()})),this.brackets&&(e="("+e+")"),e}}t.Expression=d,d.debug=!0},"./src/expression/core/Variables.ts":
/*!******************************************!*\
