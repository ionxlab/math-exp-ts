...
/*!**************************************!*\
  ...
  \**************************************/(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.ExpressionParser=void 0;const s=r(/*! ../expression */"./src/expression/index.ts"),o=r(/*! ../expression */"./src/expression/index.ts"),n=r(/*! ../expression/operators */"./src/expression/operators/index.ts"),a=r(/*! ../exceptions/BracketsMissmatchException */"./src/exceptions/BracketsMissmatchException.ts"),i=r(/*! ../exceptions/EmptyExpressionStringException */"./src/exceptions/EmptyExpressionStringException.ts"),c=r(/*! ../exceptions/UndefinedExpressionStringException */"./src/exceptions/UndefinedExpressionStringException.ts"),p=r(/*! ../exceptions/ParserException */"./src/exceptions/ParserException.ts"),u=Object.keys(n);class l{constructor(e){this.expressionStr=e}getExpressionStr(){return this.expressionStr}setExpressionStr(e){this.expressionStr=e}parse(e){if(void 0!==e&&(this.expressionStr=e),!this.expressionStr)throw new c.UndefinedExpressionStringException;if(""==this.expressionStr)throw new i.EmptyExpressionStringException;const t=this.expressionStr.match(/\d+|[a-z]+|[+\-*\/()^]|[&|]+/gi),r=t.filter((e=>"("==e)),o=t.filter((e=>")"==e));if(r.length!==o.length)throw new a.BracketsMissmatchException;let n=new s.Expression;const u=new Array;return u.push(n),t.forEach(((e,t)=>{const r=u[u.length-1],o=l.parseElem(e,r);if(!o)throw new p.ParserException("Unknown element: ["+e+"]");o instanceof s.Expression&&(o!==r?u.push(o):u.pop())})),n}static parseElem(e,t){let r,a=e.match(/^\d+$/i);if(a)return r=new o.Constant(parseFloat(e)),t.terms.push(r),r;if(a=e.match(/^\($/i),a)return r=new s.Expression,t.terms.push(r),r;if(a=e.match(/^\)$/i),a)return t;if(a=e.match(/^([a-z]+|[+\-*\/^]|[&|]+)$/i),a){for(const e of u){const s=n[e];for(const o of s.names)if(o===a[1])return r=new n[e],t.terms.push(r),r}return r=new o.Variable(a[1]),t.terms.push(r),r}}}t.ExpressionParser=l},"./src/exceptions/BracketsMissmatchException.ts":
/*!******************************************************!*\
